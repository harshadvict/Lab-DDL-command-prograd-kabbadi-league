...
-- 1. **Create table city**
CREATE TABLE CITY(ID NUMBER(11) PRIMARY KEY , NAME VARCHAR(50));
DESC CITY;
-- 2. **Create table referee**
CREATE TABLE REFEREE(ID NUMBER(11) PRIMARY KEY ,NAME VARCHAR(50)NOT NULL);

-- 3. **Create table innings**
CREATE TABLE INNINGS(ID NUMBER(11)PRIMARY KEY,INNINGS_NUMBER NUMBER(11)NOT NULL);
-- 4. **Create table extra_type**
CREATE TABLE EXTRA_TYPE(ID NUMBER(11) PRIMARY KEY, NAME VARCHAR(50)NOT NULL);
-- 5. **Create table skill**
CREATE TABLE SKILL(ID NUMBER(11) PRIMARY KEY,NAME VARCHAR(50)NOT NULL);
-- 6. **Create table team**
...
CREATE TABLE PLAYER(ID NUMBER(11) PRIMARY KEY,NAME VARCHAR(50) NOT NULL ,COUNTRY VARCHAR(50)NOT NULL ,SKILL_ID NUMBER(11)NOT NULL,TEAM_ID NUMBER(11) NOT NULL,
...
ALTER TABLE TEAM 
DROP CONSTRAINT FK_TEAM_HOME_CITY;
